...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Carbon Compass — Understand & Reduce Your Footprint" },
      { property: "og:description", content: "Measure your monthly carbon footprint and get personalized actions to live more sustainably." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Carbon Compass — Understand & Reduce Your Footprint" },
      { name: "twitter:description", content: "Measure your monthly carbon footprint and get personalized actions to live more sustainably." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/37a2be3e-b03a-4bc0-a9a5-8e69e4f9c524/id-preview-85a5f48d--251da4f7-2632-4357-889a-9e357d389399.lovable.app-1782045362514.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/37a2be3e-b03a-4bc0-a9a5-8e69e4f9c524/id-preview-85a5f48d--251da4f7-2632-4357-889a-9e357d389399.lovable.app-1782045362514.png" },
    ],
    links: [
